  ...
  <a-drawer
    ...
    <a-card :bordered="false">
        <a-form-model>
          <a-row>
            <a-col :span="5">
              <a-form-model-item label="供应商编码" :labelCol="labelCol" :wrapperCol="wrapperCol">
                <a-input  placeholder="供应商编码" v-model="queryParam.code"></a-input>
              </a-form-model-item>
            </a-col>
            <a-col :span="5">
              <a-form-model-item label="供应商名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
            ...
            <a-col :span="8" style="margin-left: 5px;margin-top: 4px">
              <a-button @click="onSearch(1)" icon="search" style="margin-right: 10px">查询</a-button>
