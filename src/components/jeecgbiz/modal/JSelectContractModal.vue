        ...
        <a-row>
          <a-col :span='6'>
            <a-form-model-item label="合同名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-input v-model='queryParam.contractName'></j-input>
            </a-form-model-item>
          </a-col>
          <a-col :span='6'>
            <a-form-model-item label="合同编码" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-input v-model='queryParam.contractNumber'></j-input>
            </a-form-model-item>
          </a-col>
          <a-col :span='6'>
...
<script>
import { filterObj, iegAmount, pushIfNotExist } from '@/utils/util'
