  ...
  <a-card :bordered='false'>
    ...
    <div>
      <a-table ref='table'
          ...
          <a @click='handleDetail(record)' v-if='tabKey == "2"'>查看报价</a>
          <a-divider type="vertical" v-if='tabKey == "2"'/>
          <a v-if='tabKey == "3" && record.isBargin == "1"' @click='handleBargain(record)'>议价</a>
				</span>
