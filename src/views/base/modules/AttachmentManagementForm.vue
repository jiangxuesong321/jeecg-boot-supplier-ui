...
<!--          <a-col :span="24">
            <a-form-model-item label="附件类型" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="attachmentType">
              <a-input v-model="model.attachmentType" placeholder="请输入附件类型"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="是否有效" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="delFlag">
              <a-input-number v-model="model.delFlag" placeholder="请输入是否有效" style="width: 100%" />
            </a-form-model-item>
          </a-col>-->
          <a-col :span="24">
          ...
          <a-col :span="24">
<!--            <a-form-model-item label="附件地址" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="attachmentPath">
              <a-textarea v-model="model.attachmentPath" rows="4" placeholder="请输入附件地址" />
            </a-form-model-item>-->
