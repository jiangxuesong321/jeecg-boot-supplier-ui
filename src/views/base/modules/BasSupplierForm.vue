<template>
  <a-card :bordered="false">
        ...
        <a-tab-pane tab="资质证书" key="1">
          ...
          >
            ...
            <template slot-scope="text,record,index" slot="valideDateBegin">
              ...
              <a-date-picker v-model="record.valideDateBegin" placeholder="有效开始日期" style="width: 100%;float: right" :disabled="formDisabled"/>
            </template>

            <template slot-scope="text,record,index" slot="valideDateEnd">
              <a-date-picker v-model="record.valideDateEnd" placeholder="有效结束日期" style="width: 100%;float: right" :disabled="formDisabled"/>
            </template>
          ...
          >
            ...
            <template slot-scope="text,record,index" slot="type">
              ...
              <j-dict-select-tag style="width:100%;" v-model="record.type" placeholder="账户性质"
                                 dictCode="account_type" :disabled="formDisabled"/>
            </template>
    ...
    <div class="drawer-footer" style="text-align: center;margin-top: 15px;">
      <a-button @click="handleOk" type="primary" style="margin-bottom: 0;margin-left:5px;">更新</a-button>
    </div>
